...
public class EditMessageBoxViewModel : IEditMessageBoxViewModel
{
    ...
    // blazor view updates this field automatically => means user is typing. It can also mean auto-update (by listening to MessageBoxState). This will cause conflict! I can keep EditMode or UpdateMode and make it switch?
